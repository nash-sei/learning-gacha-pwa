...
export const MONSTERS: MonsterDef[] = [
  ...
  // Phase 2（2026-06-17 社長公式案10体・専用画像 public/monsters/d01〜d10.webp）。
  {
    id: 'd01',
    name: 'サー・ブラッド',
    rarity: 'UR',
    blurb: 'ナイルがわを まっかに そめる、ちの はくしゃく。',
    stages: 1,
    isDanger: true,
  },
  {
    ...
    name: 'フロッグス',
    rarity: 'UR',
    blurb: 'あかい あにと あおい おとうとの きょうだいガエル。',
    stages: 1,
    isDanger: true,
  },
  {
    ...
    name: 'サンド・ポー',
    rarity: 'UR',
    blurb: 'すなあらしに すがたを かくす、なぞの かの まじん。',
    stages: 1,
    isDanger: true,
  },
  {
  ...
  },
  {
    ...
    name: 'ヘイルストン',
    rarity: 'UR',
    blurb: 'ひょうと かみなりを あやつる、こおりの きょじん。',
    stages: 1,
    isDanger: true,
  },
  {
    ...
    name: 'ソラウサギ',
    rarity: 'UR',
    blurb: 'つきで もちつきを する、きねを かかえた うさぎ。',
    stages: 1,
    isDanger: true,
  },
  {
  ...
  },
  {
    ...
    name: 'バクバクスー',
    rarity: 'UR',
    blurb: 'わるい ゆめだけを たべてくれる、やさしい ようせい。',
    stages: 1,
    isDanger: true,
  },
  {
    ...
    name: 'フォンフォン',
    rarity: 'UR',
    blurb: 'ボールで ごろごろ あそぶ、いやしけいの パンダ。',
    stages: 1,
    isDanger: true,
  },
  {
    ...
    name: 'ゴールドプニリン',
    rarity: 'UR',
    blurb: 'きんの おうかんを かたむけて つけた、スライムの おうさま。',
    stages: 1,
    isDanger: true,
  },
]
