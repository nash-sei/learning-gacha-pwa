...
export const PACK_2026_07: Question[] = [
  ...
  // ============================================================
  {
    ...
    explain: [
      '一のくらいから けいさんするよ。6 + 7 = 13。くり上がりが あるね',
  ...
  },
  {
    ...
    explain: [
      '7×7 = 49。52まで あと 3 のこるね',
      'だから 7あまり3！',
      '「6あまり10」は あまりの 10が 7より おおきいから、まだ わけられるよ',
    ],
    pack: '2026-07',
  },
  ...
  },
  {
    ...
    explain: [
      'まず ドーナツだい。90×3 = 270えん',
      'つぎに おつり。300 - 270 = 30',
      'おつりは 30えん。2だんかいで とけたね！',
    ],
    pack: '2026-07',
  },
  {
  ...
  },
  {
    ...
    explain: [
      'まず かいものの ごうけい。160 + 230 = 390えん',
      'つぎに のこり。500 - 390 を けいさんするよ',
  ...
  // ============================================================
  {
    ...
    explain: [
      'みじかい はりが 8、ながい はりが 12を さしているね',
      'ながい はりが 12のときは「ちょうど」だよ',
      'だから 8じ！',
    ],
    pack: '2026-07',
  },
  ...
  // ============================================================
  {
    ...
    explain: [
      'かどが ぜんぶ ちょっかくで、へんの ながさが みんな おなじだね',
      'だから せいほうけい！',
  ...
  },
  {
    ...
    explain: [
      'へんの ながさを みてみよう。6cmの へんが 2ほん あるね',
      '2つの へんが おなじ ながさの さんかくけいを にとうへんさんかくけいと いうよ',
  ...
  },
  {
    ...
    explain: [
      'はんたいの いみの ことばを、てんきの ことばから さがして みよう',
  ...
  },
  {
    ...
    explain: [
      '「おなかが すいたので」が りゆうだよ。ぶんの さいしょに おこう',
      'つぎは した ことの じゅんばん。「パンを やいて」→「たべました」',
